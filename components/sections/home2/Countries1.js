            ...
            <div className="auto-container">
                <div className="title-inner mb_50">
                    <div className="sec-title">
                        ...
                        <h2>Immigration Officials approvals for foreign citizens can vary by country.</h2>
                    </div>
                    <div className="text">
                        ...
                        <div className="tab-btns tab-buttons">
                            <div className="row clearfix">
                                <div className="col-lg-3 col-md-6 col-sm-12 btn-column">
                                    <div className="tab-btn active-btn" data-tab="#tab-1"><h3><i className="icon-33"></i>Education</h3></div>
                                </div>
                                <div className="col-lg-3 col-md-6 col-sm-12 btn-column">
                                    <div className="tab-btn" data-tab="#tab-2"><h3><i className="icon-34"></i>Immigration</h3></div>
                                </div>
                                <div className="col-lg-3 col-md-6 col-sm-12 btn-column">
                                    <div className="tab-btn" data-tab="#tab-3"><h3><i className="icon-14"></i>Business</h3></div>
                                </div>
                                <div className="col-lg-3 col-md-6 col-sm-12 btn-column">
                                    <div className="tab-btn" data-tab="#tab-4"><h3><i className="icon-17"></i>Tourist</h3></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="more-btn centred pt_40">
