...
export default function Home() {
    ...
    const pageKey = 'details.pages.unitedStates'
                        ...
                        <div className="countries-sidebar default-sidebar">
                            <div className="sidebar-widget category-widget">
                                <ul className="category-list clearfix">
                                    <li><Link href="countries-details" className="current">{t(`${common}.sidebar.unitedStates`)}</Link></li>
                                    ...
                                    <li><Link href="countries-details-5">{t(`${common}.sidebar.germany`)}</Link></li>
                            ...
                            <div className="sidebar-widget download-widget">
                                <div className="widget-content">
                                    ...
                                    <ul className="download-list clearfix">
                                        <li>
                                            <Link href="https://apply.usvisaconnection.com/?gad_source=1&gad_campaignid=22665371679&gbraid=0AAAAA_6f1jz2GUocerFGbWxIKqqrkpDJE&gclid=CjwKCAjwv5zEBhBwEiwAOg2YKM5qjjdsIHgc2-QkiJGUByQqI25J3u3hJ0BMUpkvKOTWzF5g3rZa4RoC10AQAvD_BwE" target="_blank">
                                                    ...
                                                    <div className="row clearfix">
                                                        ...
                                                        <div className="col-lg-6 col-md-6 col-sm-12 text-column">
                                                            <div className="text">
                                                                ...
                                                                <p>{t(`${pageKey}.working.p3`)}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="text">
                                                    <p className="mb_20">{t(`${pageKey}.working.postText1`)}</p>
                                                    <h5><strong>{t(`${pageKey}.working.checklistTitle`)}</strong></h5>
                                                </div>
                                            </div>
                                                    ...
                                                    <div className="row clearfix">
                                                        ...
                                                        <div className="col-lg-6 col-md-6 col-sm-12 text-column">
                                                            <div className="text">
                                                                ...
                                                                <p>{t(`${pageKey}.business.p3`)}</p>
                                                                <p dangerouslySetInnerHTML={{ __html: t(`${pageKey}.business.p4`) }} />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="text">
                                                    <p>{t(`${pageKey}.business.text`)}</p>
                                                </div>
                                            </div>
                                            <div className="content-three">
                                                <div className="row clearfix">
                                                    ...
                                                    <div className="row clearfix">
                                                        ...
                                                        <div className="col-lg-6 col-md-6 col-sm-12 text-column">
                                                            <div className="text">
                                                                ...
                                                                <p>{t(`${pageKey}.education.p3`)}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="text">
                                                    <p>{t(`${pageKey}.education.text`)}</p>
                                                </div>
                                            </div>
                                            <div className="content-three">
                                                <div className="row clearfix">
                                                    ...
                                                    <div className="row clearfix">
                                                        ...
                                                        <div className="col-lg-6 col-md-6 col-sm-12 text-column">
                                                            <div className="text">
                                                                ...
                                                                <p>{t(`${pageKey}.tourist.p3`)}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="text">
                                                    <p>{t(`${pageKey}.tourist.text1`)}</p>
                                                    <p>{t(`${pageKey}.tourist.text2`)}</p>
                                                    <p>{t(`${pageKey}.tourist.preChecklist`)}</p>
                                                </div>
                                            </div>
                                            <div className="content-three">
                                                <div className="row clearfix">
