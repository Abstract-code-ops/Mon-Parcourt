...
export default function Home() {
    ...
    return (
        <>
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle={t('breadcrumb.businessVisa')} bgImage="url(assets/images/background/visa-breadcrumb.jpg)">
                ...
                <div className="auto-container">
                    ...
                    <div className="col-lg-4 col-md-12 col-sm-12 sidebar-side">
                        ...
                        <div className="sidebar-widget category-widget">
                            ...
                            <li><Link href="visa-details" className="current">{t('breadcrumb.businessVisa')}</Link></li>
                    ...
                    <div className="col-lg-8 col-md-12 col-sm-12 content-side">
                        ...
                        <div className="content-one mb_60">
                            ...
                            <p>{t('pages.business.intro')}</p>
                            </div>
                            <figure className="image-box"><img src="assets/images/resource/visa-12.jpg" alt="" /></figure>
                            <div className="lower-text">
                            <p>{t('pages.business.lower')}</p>
                            </div>
                        </div>
                        <div className="content-two mb_35">
                            ...
                            <div className="col-lg-6 col-md-6 col-sm-12 left-column">
                                ...
                                <h3>{t('pages.business.leftTitle')}</h3>
                                <p>{t('pages.business.leftP1')}</p>
                                <p><Trans i18nKey="pages.business.leftP2" ns="visa" /></p>
                                </div>
                            </div>
                            <div className="col-lg-6 col-md-6 col-sm-12 right-column">
                                <div className="right-content">
                                <h3>{t('pages.business.rightTitle')}</h3>
                                <ul className="list-item clearfix">
                                    <li><Link href="javascript:void(0)" style={{"cursor": "default"}}>{t('pages.business.r1')}</Link></li>
                                    <li><Link href="javascript:void(0)" style={{"cursor": "default"}}>{t('pages.business.r2')}</Link></li>
                                    <li><Link href="javascript:void(0)" style={{"cursor": "default"}}>{t('pages.business.r3')}</Link></li>
                                </ul>
                                </div>
                            </div>
                            </div>
