...
export default function Home() {
  ...
  const handleOnClick = (index) => {
    ...
    const getChecklist = (path) => t(path, { returnObjects: true }) || []
    return (
        <>
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle={t('details.pages.australia.breadcrumbTitle')} bgImage="url(assets/images/background/countries-breadcrumb.jpg)">
                {/* countries section */}
                        ...
                        <div className="countries-sidebar default-sidebar">
                            <div className="sidebar-widget category-widget">
                                <ul className="category-list clearfix">
                                    ...
                                    <li><Link href="/countries-details-6" className="current">{t('details.common.sidebar.australia')}</Link></li>
                                ...
                                <div className="widget-content p_relative">
                                    ...
                                    <div className="content-box">
                                        ...
                                        <ul className="list-item clearfix">
                                            {getChecklist('details.common.widgets.travelPass.list').map((item, idx) => (
                                                <li key={idx}>{item}</li>
                                            ))}
                                        </ul>
                                    </div>
                            ...
                            <div className="sidebar-widget download-widget">
                                <div className="widget-content">
                                    ...
                                    <h3 dangerouslySetInnerHTML={{ __html: t('details.common.widgets.download.title').replace(' / ', ' / <br />') }} />
                                    <ul className="download-list clearfix">
                                        <li>
                                            <Link href="https://immi.homeaffairs.gov.au/help-support/applying-online-or-on-paper/online" target="_blank">
                                                <i className="icon-50"></i>
                                                <p>{t('details.pages.australia.downloads.link1.label')}</p>
                                                <span>{t('details.pages.australia.downloads.link1.meta')}</span>
                                            </Link>
                                        </li>
                                        <li>
                                            <Link href="https://immi.homeaffairs.gov.au/help-support/applying-online-or-on-paper/online" target="_blank">
                                                <i className="icon-50"></i>
                                                <p>{t('details.pages.australia.downloads.link2.label')}</p>
                                                <span>{t('details.pages.australia.downloads.link2.meta')}</span>
                                            </Link>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div className="tab-content wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1200ms">
                                        ...
                                        <div className="content-box">
                                            <div className="content-one mb_30">
                                                <div className="upper-text mb_30">
                                                    <h2>{t('details.pages.australia.working.title')}</h2>
                                                    <p>{t('details.pages.australia.working.p1')}</p>
                                                </div>
                                                <div className="two-column mb_30">
                                                    <div className="row clearfix">
                                                        <div className="col-lg-6 col-md-6 col-sm-12 image-column">
                                                            <figure className="image-box"><img src="assets/images/resource/australia-visa.jpg" alt="" /></figure>
                                                        </div>
                                                        <div className="col-lg-6 col-md-6 col-sm-12 text-column">
                                                            <div className="text">
                                                                    <h3>{t('details.pages.australia.working.overviewTitle')}</h3>
                                                                    <p>{t('details.pages.australia.working.p2')}</p>
                                                                </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="text">
                                                    <h5><br/><strong>{t('details.pages.australia.working.preChecklist')}</strong></h5>
                                                </div>
                                            </div>
                                                ...
                                                <div className="row clearfix">
                                                    <div className="col-lg-5 col-md-6 col-sm-12 list-column">
                                                        <ul className="list-item clearfix mr_40">
                                                            {getChecklist('details.pages.australia.working.checklist').map((item, idx) => (
                                    ...
                                    <div className={activeIndex == 2 ? "tab-pane fadeInUp animated show active" : "tab-pane fadeInUp animated"}>
                                        <div className="content-box">
                                            <div className="content-one mb_30">
                                                <div className="upper-text mb_30">
                                                    <h2>{t('details.pages.australia.business.title')}</h2>
                                                    <p>{t('details.pages.australia.business.p1')}</p>
                                                </div>
                                                <div className="two-column mb_30">
                                                    <div className="row clearfix">
                                                        <div className="col-lg-6 col-md-6 col-sm-12 image-column">
                                                        ...
                                                        <div className="col-lg-6 col-md-6 col-sm-12 text-column">
                                                            <div className="text">
                                                                <h3>{t('details.pages.australia.business.overviewTitle')}</h3>
                                                                <p>{t('details.pages.australia.business.p2')}</p>
                                                                <p>{t('details.pages.australia.business.p3')}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="text">
                                                    <h5><br/><strong>{t('details.pages.australia.business.preChecklist')}</strong></h5>
                                                </div>
                                            </div>
                                            <div className="content-three">
                                                <div className="row clearfix">
                                                    <div className="col-lg-5 col-md-6 col-sm-12 list-column">
                                                        <ul className="list-item clearfix mr_40">
                                                            {getChecklist('details.pages.australia.business.checklist').map((item, idx) => (
                                                                <li key={idx}><h5>{item}</h5></li>
                                                            ))}
                                                        </ul>
                                                    </div>
                                    ...
                                    <div className={activeIndex == 3 ? "tab-pane fadeInUp animated show active" : "tab-pane fadeInUp animated"}>
                                        <div className="content-box">
                                            <div className="content-one mb_30">
                                                <div className="upper-text mb_30">
                                                    <h2>{t('details.pages.australia.education.title')}</h2>
                                                    <p>{t('details.pages.australia.education.p1')}</p>
                                                </div>
                                                <div className="two-column mb_30">
                                                    <div className="row clearfix">
                                                        <div className="col-lg-6 col-md-6 col-sm-12 image-column">
                                                        ...
                                                        <div className="col-lg-6 col-md-6 col-sm-12 text-column">
                                                            <div className="text">
                                                                <h3>{t('details.pages.australia.education.overviewTitle')}</h3>
                                                                <p>{t('details.pages.australia.education.p2')}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="text">
                                                    <h5><br/><strong>{t('details.pages.australia.education.preChecklist')}</strong></h5>
                                                </div>
                                            </div>
                                            <div className="content-three">
                                                <div className="row clearfix">
                                                    <div className="col-lg-5 col-md-6 col-sm-12 list-column">
                                                        <ul className="list-item clearfix mr_40">
                                                            {getChecklist('details.pages.australia.education.checklist').map((item, idx) => (
                                                                <li key={idx}><h5>{item}</h5></li>
                                                            ))}
                                                        </ul>
                                                    </div>
                                    ...
                                    <div className={activeIndex == 4 ? "tab-pane fadeInUp animated show active" : "tab-pane fadeInUp animated"}>
                                        <div className="content-box">
                                            <div className="content-one mb_30">
                                                <div className="upper-text mb_30">
                                                    <h2>{t('details.pages.australia.tourist.title')}</h2>
                                                    <p>{t('details.pages.australia.tourist.p1')}</p>
                                                </div>
                                                <div className="two-column mb_30">
                                                    <div className="row clearfix">
                                                        <div className="col-lg-6 col-md-6 col-sm-12 image-column">
                                                        ...
                                                        <div className="col-lg-6 col-md-6 col-sm-12 text-column">
                                                            <div className="text">
                                                                <h3>{t('details.pages.australia.tourist.overviewTitle')}</h3>
                                                                <p>{t('details.pages.australia.tourist.p2')}</p>
                                                                <p dangerouslySetInnerHTML={{ __html: t('details.pages.australia.tourist.p3') }} />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="text">
                                                    <h5><br/><strong>{t('details.pages.australia.tourist.preChecklist')}</strong></h5>
                                                </div>
                                            </div>
                                            <div className="content-three">
                                                <div className="row clearfix">
                                                    <div className="col-lg-5 col-md-6 col-sm-12 list-column">
                                                        <ul className="list-item clearfix mr_40">
                                                            {getChecklist('details.pages.australia.tourist.checklist').map((item, idx) => (
                                                                <li key={idx}><h5>{item}</h5></li>
                                                            ))}
                                                        </ul>
                                                    </div>
