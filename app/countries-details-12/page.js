...
export default function Home() {
    ...
    return (
        <>
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle={t('details.pages.northCyprus.breadcrumbTitle')} bgImage="url(assets/images/background/countries-breadcrumb.jpg)">
                {/* countries section */}
                        ...
                        <div className="countries-sidebar default-sidebar">
                            <div className="sidebar-widget category-widget">
                                <ul className="category-list clearfix">
                                    ...
                                    <li><Link href="countries-details-8">{t('details.common.sidebar.turkey')}</Link></li>
                                    <li><Link href="countries-details-12" className="current">{t('details.common.sidebar.northCyprus')}</Link></li>
                            ...
                            <div className="sidebar-widget download-widget">
                                <div className="widget-content">
                                    ...
                                    <ul className="download-list clearfix">
                                        <li>
                                            <Link href="https://www.gov.ct.tr/en/visa-application" target="_blank">
                                            <i className="icon-50"></i>
                                            <p>{t('details.pages.northCyprus.downloads.link1.label')}</p>
                                            <span>{t('details.pages.northCyprus.downloads.link1.meta')}</span>
                                            </Link>
                                        </li>
                                        <li>
                                            <Link href="https://www.evisa.gov.ct.tr" target="_blank">
                                            <i className="icon-50"></i>
                                            <p>{t('details.pages.northCyprus.downloads.link2.label')}</p>
                                            <span>{t('details.pages.northCyprus.downloads.link2.meta')}</span>
                                            </Link>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div className="tab-content wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1200ms">
                                        ...
                                        <div className="content-box">
                                            <div className="content-one mb_30">
                                                <div className="upper-text mb_30">
                                                    <h2>{t('details.pages.northCyprus.working.title')}</h2>
                                                    <p>{t('details.pages.northCyprus.working.p1')}</p>                                                </div>
                                                <div className="two-column mb_30">
                                                    <div className="row clearfix">
                                                        <div className="col-lg-6 col-md-6 col-sm-12 image-column">
                                                            <figure className="image-box"><img src="assets/images/resource/trnc-custom.jpg" alt="" /></figure>
                                                        </div>
                                                        <div className="col-lg-6 col-md-6 col-sm-12 text-column">
                                                            <div className="text">
                                                                    <h3>{t('details.pages.northCyprus.working.overviewTitle')}</h3>
                                                                    <p>{t('details.pages.northCyprus.working.p2')}</p>                                                                </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="text">
                                                    <h5><br/><strong>{t('details.pages.northCyprus.working.preChecklist')}</strong></h5>
                                                </div>
                                            </div>
                                                ...
                                                <div className="row clearfix">
                                                    <div className="col-lg-5 col-md-6 col-sm-12 list-column">
                                                        <ul className="list-item clearfix mr_40">
                                                            {Array.isArray(t('details.pages.northCyprus.working.checklist', { returnObjects: true })) ? (
                                                                t('details.pages.northCyprus.working.checklist', { returnObjects: true }).map((item, idx) => (
                                                                    <li key={`nc-work-${idx}`}><h5>{item}</h5></li>
                                                                ))
                                                            ) : <h2>NOT AVAILABLE</h2>}
                                                        </ul>
                                                    </div>
                                    ...
                                    <div className={activeIndex == 2 ? "tab-pane fadeInUp animated show active" : "tab-pane fadeInUp animated"}>
                                        <div className="content-box">
                                            <div className="content-one mb_30">
                                                <div className="upper-text mb_30">
                                                    <h2>{t('details.pages.northCyprus.business.title')}</h2>
                                                    <p>{t('details.pages.northCyprus.business.p1')}</p>                                                </div>
                                                <div className="two-column mb_30">
                                                    <div className="row clearfix">
                                                        <div className="col-lg-6 col-md-6 col-sm-12 image-column">
                                                            <figure className="image-box"><img src="assets/images/resource/trnc-custom.jpg" alt="" /></figure>
                                                        ...
                                                        <div className="col-lg-6 col-md-6 col-sm-12 text-column">
                                                            <div className="text">
                                                                <h3>{t('details.pages.northCyprus.business.overviewTitle')}</h3>
                                                                <p>{t('details.pages.northCyprus.business.p2')}</p>                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="text">
                                                    <h5><br/><strong>{t('details.pages.northCyprus.business.preChecklist')}</strong></h5>
                                                </div>
                                            </div>
                                            <div className="content-three">
                                                <div className="row clearfix">
                                                    <div className="col-lg-5 col-md-6 col-sm-12 list-column">
                                                        <ul className="list-item clearfix mr_40">
                                                            {Array.isArray(t('details.pages.northCyprus.business.checklist', { returnObjects: true })) ? (
                                                                t('details.pages.northCyprus.business.checklist', { returnObjects: true }).map((item, idx) => (
                                                                    <li key={`nc-visit-${idx}`}><h5>{item}</h5></li>
                                                                ))
                                                            ) : <h2>NOT AVAILABLE</h2>}
                                                        </ul>
                                                    </div>
                                    ...
                                    <div className={activeIndex == 3 ? "tab-pane fadeInUp animated show active" : "tab-pane fadeInUp animated"}>
                                        <div className="content-box">
                                            <div className="content-one mb_30">
                                                <div className="upper-text mb_30">
                                                    <h2>{t('details.pages.northCyprus.education.title')}</h2>
                                                    <p>{t('details.pages.northCyprus.education.p1')}</p>                                                </div>
                                                <div className="two-column mb_30">
                                                    <div className="row clearfix">
                                                        <div className="col-lg-6 col-md-6 col-sm-12 image-column">
                                                            <figure className="image-box"><img src="assets/images/resource/trnc-custom.jpg" alt="" /></figure>
                                                        ...
                                                        <div className="col-lg-6 col-md-6 col-sm-12 text-column">
                                                            <div className="text">
                                                                <h3>{t('details.pages.northCyprus.education.overviewTitle')}</h3>
                                                              <p>{t('details.pages.northCyprus.education.p2')}</p>                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="text">
                                                    <h5><br/><strong>{t('details.pages.northCyprus.education.preChecklist')}</strong></h5>
                                                </div>
                                            </div>
                                            <div className="content-three">
                                                <div className="row clearfix">
                                                    <div className="col-lg-5 col-md-6 col-sm-12 list-column">
                                                        <ul className="list-item clearfix mr_40">
                                                            {Array.isArray(t('details.pages.northCyprus.education.checklist', { returnObjects: true })) ? (
                                                                t('details.pages.northCyprus.education.checklist', { returnObjects: true }).map((item, idx) => (
                                                                    <li key={`nc-edu-${idx}`}><h5>{item}</h5></li>
                                                                ))
                                                            ) : <h2>NOT AVAILABLE</h2>}
                                                        </ul>
                                                    </div>
                                    ...
                                    <div className={activeIndex == 4 ? "tab-pane fadeInUp animated show active" : "tab-pane fadeInUp animated"}>
                                        <div className="content-box">
                                            <div className="content-one mb_30">
                                                <div className="upper-text mb_30">
                                                    <h2>{t('details.pages.northCyprus.tourist.title')}</h2>
                                                    <p>{t('details.pages.northCyprus.tourist.p1')}</p>                                                </div>
                                                <div className="two-column mb_30">
                                                    <div className="row clearfix">
                                                        <div className="col-lg-6 col-md-6 col-sm-12 image-column">
                                                            <figure className="image-box"><img src="assets/images/resource/trnc-custom.jpg" alt="" /></figure>
                                                        ...
                                                        <div className="col-lg-6 col-md-6 col-sm-12 text-column">
                                                            <div className="text">
                                                                <h3>{t('details.pages.northCyprus.tourist.overviewTitle')}</h3>
                                                                <p>{t('details.pages.northCyprus.tourist.p2')}</p>                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="text">
                                                    <h5><br/><strong>{t('details.pages.northCyprus.tourist.preChecklist')}</strong></h5>
                                                </div>
                                            </div>
                                            <div className="content-three">
                                                <div className="row clearfix">
                                                    <div className="col-lg-5 col-md-6 col-sm-12 list-column">
                                                        <ul className="list-item clearfix mr_40">
                                                            {Array.isArray(t('details.pages.northCyprus.tourist.checklist', { returnObjects: true })) ? (
                                                                t('details.pages.northCyprus.tourist.checklist', { returnObjects: true }).map((item, idx) => (
                                                                    <li key={`nc-tour-${idx}`}><h5>{item}</h5></li>
                                                                ))
                                                            ) : <h2>NOT AVAILABLE</h2>}
                                                        </ul>
                                                    </div>
