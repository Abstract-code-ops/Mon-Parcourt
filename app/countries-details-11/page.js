...
export default function Home() {
  ...
  const handleOnClick = (index) => {
    ...
    // Helpers to fetch array translations
    const travelPassList = t('details.common.widgets.travelPass.list', { returnObjects: true }) || []
    const workingChecklist = t('details.pages.uae.working.checklist', { returnObjects: true }) || []
    const touristChecklist = t('details.pages.uae.tourist.checklist', { returnObjects: true }) || []
    const educationChecklist = t('details.pages.uae.education.checklist', { returnObjects: true }) || []
    const familyChecklist = t('details.pages.uae.business.checklist', { returnObjects: true }) || []

    return (
        <>
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle={t('details.pages.uae.breadcrumbTitle')} bgImage="url(assets/images/background/countries-breadcrumb.jpg)">
                {/* countries section */}
                        ...
                        <div className="countries-sidebar default-sidebar">
                            <div className="sidebar-widget category-widget">
                                <ul className="category-list clearfix">
                                    ...
                                    <li><Link href="countries-details-11"  className="current">{t('details.common.sidebar.uae')}</Link></li>
                                </ul>
                            </div>
                            ...
                            <div className="sidebar-widget download-widget">
                                <div className="widget-content">
                                    ...
                                    <ul className="download-list clearfix">
                                        <li>
                                            <Link href="https://icp.gov.ae/en/" target="_blank">
                                                <i className="icon-50"></i>
                                                <p>{t('details.pages.uae.downloads.link1.label')}</p>
                                                <span>{t('details.pages.uae.downloads.link1.meta')}</span>
                                            </Link>
                                        </li>
                                        <li>
                                            <Link href="https://gdrfad.gov.ae/en" target="_blank">
                                                <i className="icon-50"></i>
                                                <p>{t('details.pages.uae.downloads.link2.label')}</p>
                                                <span>{t('details.pages.uae.downloads.link2.meta')}</span>
                                            </Link>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div className="tab-btn-box pb_60">
                                    <ul className="tab-btns tab-buttons clearfix" role="tablist">
                                        ...
                                        <li className="nav-item" onClick={() => handleOnClick(2)}>
                                            <a className={activeIndex == 2 ? "nav-link active" : "nav-link"}><h5><i className="icon-53"></i>{t('details.common.tabs.tourist')}</h5></a>
                                        </li>
                                        ...
                                        <li className="nav-item" onClick={() => handleOnClick(4)}>
                                            <a className={activeIndex == 4 ? "nav-link active" : "nav-link"}><h5><i className="icon-55"></i>{t('details.common.tabs.business')}</h5></a>
                                        </li>
                                    </ul>
                                </div>
                                <div className="tab-content wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1200ms">
                                        ...
                                        <div className="content-box">
                                            <div className="content-one mb_30">
                                                <div className="upper-text mb_30">
                                                    <h2>{t('details.pages.uae.working.title')}</h2>
                                                    <p>{t('details.pages.uae.working.p1')}</p>
                                                </div>
                                                <div className="two-column mb_30">
                                                    <div className="row clearfix">
                                                        <div className="col-lg-6 col-md-6 col-sm-12 image-column">
                                                            <figure className="image-box"><img src="assets/images/resource/dubai-custom.jpg" alt="" /></figure>
                                                        </div>
                                                        <div className="col-lg-6 col-md-6 col-sm-12 text-column">
                                                            <div className="text">
                                                                    <h3>{t('details.pages.uae.working.overviewTitle')}</h3>
                                                                    <p>{t('details.pages.uae.working.p2')}</p>
                                                                </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="text">
                                                    <h5><br/><strong>{t('details.pages.uae.working.preChecklist')}</strong></h5>
                                                </div>
                                            </div>
                                    ...
                                    <div className={activeIndex == 2 ? "tab-pane fadeInUp animated show active" : "tab-pane fadeInUp animated"}>
                                        <div className="content-box">
                                            <div className="content-one mb_30">
                                                <div className="upper-text mb_30">
                                                    <h2>{t('details.pages.uae.tourist.title')}</h2>
                                                    <p>{t('details.pages.uae.tourist.p1')}</p>
                                                </div>
                                                <div className="two-column mb_30">
                                                    <div className="row clearfix">
                                                        <div className="col-lg-6 col-md-6 col-sm-12 image-column">
                                                        ...
                                                        <div className="col-lg-6 col-md-6 col-sm-12 text-column">
                                                            <div className="text">
                                                                <h3>{t('details.pages.uae.tourist.overviewTitle')}</h3>
                                                                <p>{t('details.pages.uae.tourist.p2')}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="text">
                                                    <h5><br/><strong>{t('details.pages.uae.tourist.preChecklist')}</strong></h5>
                                                </div>
                                            </div>
                                    ...
                                    <div className={activeIndex == 3 ? "tab-pane fadeInUp animated show active" : "tab-pane fadeInUp animated"}>
                                        <div className="content-box">
                                            <div className="content-one mb_30">
                                                <div className="upper-text mb_30">
                                                    <h2>{t('details.pages.uae.education.title')}</h2>
                                                    <p>{t('details.pages.uae.education.p1')}</p>
                                                </div>
                                                <div className="two-column mb_30">
                                                    <div className="row clearfix">
                                                        <div className="col-lg-6 col-md-6 col-sm-12 image-column">
                                                        ...
                                                        <div className="col-lg-6 col-md-6 col-sm-12 text-column">
                                                            <div className="text">
                                                                <h3>{t('details.pages.uae.education.overviewTitle')}</h3>
                                                                <p>{t('details.pages.uae.education.p2')}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="text">
                                                    <h5><br/><strong>{t('details.pages.uae.education.preChecklist')}</strong></h5>
                                                </div>
                                            </div>
                                            <div className="content-three">
                                                <div className="row clearfix">
                                                    <div className="col-lg-5 col-md-6 col-sm-12 list-column">
                                                        <ul className="list-item clearfix mr_40">
                                                            {educationChecklist.map((item, idx) => (
                                                                <li key={idx}><h5>{item}</h5></li>
                                                            ))}
                                                        </ul>
                                                    </div>
                                    ...
                                    <div className={activeIndex == 4 ? "tab-pane fadeInUp animated show active" : "tab-pane fadeInUp animated"}>
                                        <div className="content-box">
                                            <div className="content-one mb_30">
                                                <div className="upper-text mb_30">
                                                    <h2>{t('details.pages.uae.business.title')}</h2>
                                                    <p>{t('details.pages.uae.business.p1')}</p>
                                                </div>
                                                <div className="two-column mb_30">
                                                    <div className="row clearfix">
                                                        <div className="col-lg-6 col-md-6 col-sm-12 image-column">
                                                        ...
                                                        <div className="col-lg-6 col-md-6 col-sm-12 text-column">
                                                            <div className="text">
                                                                <h3>{t('details.pages.uae.business.overviewTitle')}</h3>
                                                                <p>{t('details.pages.uae.business.p2')}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="text">
                                                    <h5><br/><strong>{t('details.pages.uae.business.preChecklist')}</strong></h5>
                                                </div>
                                            </div>
                                            <div className="content-three">
                                                <div className="row clearfix">
