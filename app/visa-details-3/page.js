...
export default function Home() {
    ...
    return (
        <>
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle={t('breadcrumb.residenceVisas')} bgImage="url(assets/images/background/visa-breadcrumb.jpg)">
                ...
                <div className="auto-container">
                    ...
                    <div className="col-lg-4 col-md-12 col-sm-12 sidebar-side">
                        ...
                        <div className="sidebar-widget category-widget">
                            ...
                            <li><Link href="visa-details-3" className="current">{t('breadcrumb.residenceVisas')}</Link></li>
                    ...
                    <div className="col-lg-8 col-md-12 col-sm-12 content-side">
                        ...
                        <div className="content-two mb_35">
                            ...
                            <div className="col-lg-6 col-md-6 col-sm-12 left-column">
                                ...
                                <h3>{t('pages.residence.leftTitle')}</h3>
                                <p>{t('pages.residence.leftP1')}</p>
                                <p><Trans i18nKey="pages.residence.leftP2" ns="visa" /></p>                                </div>
                            </div>
                            <div className="col-lg-6 col-md-6 col-sm-12 right-column">
                                <div className="right-content">
                                    <h3>{t('pages.residence.rightTitle')}</h3>
                                    <ul className="list-item clearfix">
                                        <li><Link href="javascript:void(0)" style={{"cursor": "default"}}>{t('pages.residence.r1')}</Link></li>
                                        <li><Link href="javascript:void(0)" style={{"cursor": "default"}}>{t('pages.residence.r2')}</Link></li>
                                        <li><Link href="javascript:void(0)" style={{"cursor": "default"}}>{t('pages.residence.r3')}</Link></li>
                                    </ul>
                                </div>
                            </div>
                            </div>
