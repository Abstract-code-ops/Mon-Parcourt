...
export default function Home() {
  ...
  const handleOnClick = (index) => {
    ...
    return (
        <>
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle={t('details.pages.lithuania.breadcrumbTitle')} bgImage="url(assets/images/background/countries-breadcrumb.jpg)">
                {/* countries section */}
                        ...
                        <div className="countries-sidebar default-sidebar">
                            <div className="sidebar-widget category-widget">
                                <ul className="category-list clearfix">
                                    ...
                                    <li><Link href="countries-details-9" className="current">{t('details.common.sidebar.lithuania')}</Link></li>
                            ...
                            <div className="sidebar-widget download-widget">
                                <div className="widget-content">
                                    ...
                                    <ul className="download-list clearfix">
                                        <li>
                                            <Link href="https://www.migracija.lt/en/home" target="_blank">
                                                <i className="icon-50"></i>
                                                <p>{t('details.pages.lithuania.downloads.link1.label')}</p>
                                                <span>{t('details.pages.lithuania.downloads.link1.meta')}</span>
                                            </Link>
                                        </li>
                                        <li>
                                            <Link href="https://www.vfsglobal.com/en/individuals/index.html" target="_blank">
                                                <i className="icon-50"></i>
                                                <p>{t('details.pages.lithuania.downloads.link2.label')}</p>
                                                <span>{t('details.pages.lithuania.downloads.link2.meta')}</span>
                                            </Link>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div className="tab-content wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1200ms">
                                        ...
                                        <div className="content-box">
                                            <div className="content-one mb_30">
                                                <div className="upper-text mb_30">
                                                    <h2>{t('details.pages.lithuania.working.title')}</h2>
                                                    <p>{t('details.pages.lithuania.working.p1')}</p>
                                                </div>
                                                <div className="two-column mb_30">
                                                    <div className="row clearfix">
                                                        <div className="col-lg-6 col-md-6 col-sm-12 image-column">
                                                            <figure className="image-box"><img src="assets/images/resource/lithuania-custom.jpg" alt="" /></figure>
                                                        </div>
                                                        <div className="col-lg-6 col-md-6 col-sm-12 text-column">
                                                            <div className="text">
                                                                    <h3>{t('details.pages.lithuania.working.overviewTitle')}</h3>
                                                                    <p>{t('details.pages.lithuania.working.p2')}</p>
                                                                </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="text">
                                                    <h5><br/><strong>{t('details.pages.lithuania.working.preChecklist')}</strong></h5>
                                                </div>
                                            </div>
                                                ...
                                                <div className="row clearfix">
                                                    <div className="col-lg-5 col-md-6 col-sm-12 list-column">
                                                        <ul className="list-item clearfix mr_40">
                                                            {Array.isArray(t('details.pages.lithuania.working.checklist', { returnObjects: true })) ? (
                                                                t('details.pages.lithuania.working.checklist', { returnObjects: true }).map((item, idx) => (
                                                                    <li key={`lt-work-${idx}`}><h5>{item}</h5></li>
                                                                ))
                                                            ) : <h2>NOT AVAILABLE</h2>}
                                                        </ul>
                                                    </div>
                                    ...
                                    <div className={activeIndex == 2 ? "tab-pane fadeInUp animated show active" : "tab-pane fadeInUp animated"}>
                                        <div className="content-box">
                                            <div className="content-one mb_30">
                                                <div className="upper-text mb_30">
                                                    <h2>{t('details.pages.lithuania.business.title')}</h2>
                                                    <p>{t('details.pages.lithuania.business.p1')}</p>
                                                </div>
                                                <div className="two-column mb_30">
                                                    <div className="row clearfix">
                                                        <div className="col-lg-6 col-md-6 col-sm-12 image-column">
                                                        ...
                                                        <div className="col-lg-6 col-md-6 col-sm-12 text-column">
                                                            <div className="text">
                                                                <h3>{t('details.pages.lithuania.business.overviewTitle')}</h3>
                                                                <p>{t('details.pages.lithuania.business.p2')}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="text">
                                                    <h5><br/><strong>{t('details.pages.lithuania.business.preChecklist')}</strong></h5>
                                                </div>
                                            </div>
                                            <div className="content-three">
                                                <div className="row clearfix">
                                                    <div className="col-lg-5 col-md-6 col-sm-12 list-column">
                                                        <ul className="list-item clearfix mr_40">
                                                            {Array.isArray(t('details.pages.lithuania.business.checklist', { returnObjects: true })) ? (
                                                                t('details.pages.lithuania.business.checklist', { returnObjects: true }).map((item, idx) => (
                                                                    <li key={`lt-visit-${idx}`}><h5>{item}</h5></li>
                                                                ))
                                                            ) : <h2>NOT AVAILABLE</h2>}
                                                        </ul>
                                                    </div>
                                    ...
                                    <div className={activeIndex == 3 ? "tab-pane fadeInUp animated show active" : "tab-pane fadeInUp animated"}>
                                        <div className="content-box">
                                            <div className="content-one mb_30">
                                                <div className="upper-text mb_30">
                                                    <h2>{t('details.pages.lithuania.education.title')}</h2>
                                                    <p>{t('details.pages.lithuania.education.p1')}</p>
                                                </div>
                                                <div className="two-column mb_30">
                                                    <div className="row clearfix">
                                                        <div className="col-lg-6 col-md-6 col-sm-12 image-column">
                                                        ...
                                                        <div className="col-lg-6 col-md-6 col-sm-12 text-column">
                                                            <div className="text">
                                                                <h3>{t('details.pages.lithuania.education.overviewTitle')}</h3>
                                                                <p>{t('details.pages.lithuania.education.p2')}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="text">
                                                    <h5><br/><strong>{t('details.pages.lithuania.education.preChecklist')}</strong></h5>
                                                </div>
                                            </div>
                                            <div className="content-three">
                                                <div className="row clearfix">
                                                    <div className="col-lg-5 col-md-6 col-sm-12 list-column">
                                                        <ul className="list-item clearfix mr_40">
                                                            {Array.isArray(t('details.pages.lithuania.education.checklist', { returnObjects: true })) ? (
                                                                t('details.pages.lithuania.education.checklist', { returnObjects: true }).map((item, idx) => (
                                                                    <li key={`lt-edu-${idx}`}><h5>{item}</h5></li>
                                                                ))
                                                            ) : <h2>NOT AVAILABLE</h2>}
                                                        </ul>
                                                    </div>
                                    ...
                                    <div className={activeIndex == 4 ? "tab-pane fadeInUp animated show active" : "tab-pane fadeInUp animated"}>
                                        <div className="content-box">
                                            <div className="content-one mb_30">
                                                <div className="upper-text mb_30">
                                                    <h2>{t('details.pages.lithuania.tourist.title')}</h2>
                                                    <p>{t('details.pages.lithuania.tourist.p1')}</p>
                                                </div>
                                                <div className="two-column mb_30">
                                                    <div className="row clearfix">
                                                        <div className="col-lg-6 col-md-6 col-sm-12 image-column">
                                                        ...
                                                        <div className="col-lg-6 col-md-6 col-sm-12 text-column">
                                                            <div className="text">
                                                                <h3>{t('details.pages.lithuania.tourist.overviewTitle')}</h3>
                                                                <p>{t('details.pages.lithuania.tourist.p2')}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="text">
                                                    <h5><br/><strong>{t('details.pages.lithuania.tourist.preChecklist')}</strong></h5>
                                                </div>
                                            </div>
                                            <div className="content-three">
                                                <div className="row clearfix">
                                                    <div className="col-lg-5 col-md-6 col-sm-12 list-column">
                                                        <ul className="list-item clearfix mr_40">
                                                            {Array.isArray(t('details.pages.lithuania.tourist.checklist', { returnObjects: true })) ? (
                                                                t('details.pages.lithuania.tourist.checklist', { returnObjects: true }).map((item, idx) => (
                                                                    <li key={`lt-tour-${idx}`}><h5>{item}</h5></li>
                                                                ))
                                                            ) : <h2>NOT AVAILABLE</h2>}
                                                        </ul>
                                                    </div>
