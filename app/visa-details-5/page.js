...
export default function Home() {
    ...
    return (
        <>
        <Layout headerStyle={1} footerStyle={1} breadcrumbTitle={t('breadcrumb.spouseFamilyVisas')} bgImage="url(assets/images/background/visa-breadcrumb.jpg)">
                ...
                <li><Link href="visa-details-5" className="current">{t('breadcrumb.spouseFamilyVisas')}</Link></li>
                ...
                <p>{t('pages.spouse.lower')}</p>
                    ...
                    <h3>{t('pages.spouse.leftTitle')}</h3>
                    <p>{t('pages.spouse.leftP1')}</p>
                    <p><Trans i18nKey="pages.spouse.leftP2" ns="visa" /></p>
                                </div>
                            </div>
                            <div className="col-lg-6 col-md-6 col-sm-12 right-column">
                                <div className="right-content">
                    <h3>{t('pages.spouse.rightTitle')}</h3>
                                    <ul className="list-item clearfix">
                    <li><Link href="javascript:void(0)" style={{"cursor": "default"}}>{t('pages.spouse.r1')}</Link></li>
                    <li><Link href="javascript:void(0)" style={{"cursor": "default"}}>{t('pages.spouse.r2')}</Link></li>
                    <li><Link href="javascript:void(0)" style={{"cursor": "default"}}>{t('pages.spouse.r3')}</Link></li>
                                    </ul>
                                </div>
                            </div>
                            </div>
