...
export default function Home() {
  ...
  const pageKey = 'details.pages.spain'
                        ...
                        <div className="countries-sidebar default-sidebar">
                            <div className="sidebar-widget category-widget">
                                <ul className="category-list clearfix">
                                    ...
                                    <li><Link href="countries-details-7" className="current">{t(`${common}.sidebar.spain`)}</Link></li>
                            ...
                            <div className="sidebar-widget download-widget">
                                <div className="widget-content">
                                    ...
                                    <ul className="download-list clearfix">
                                        <li>
                                            <Link href="https://www.exteriores.gob.es/en/ServiciosAlCiudadano/Paginas/Servicios-consulares.aspx" target="_blank">
                                        ...
                                        <li>
                                            <Link href="https://www.exteriores.gob.es/es/Paginas/index.aspx" target="_blank">
                                                <i className="icon-50"></i>
                                                ...
                                                <div className="two-column mb_30">
                                                    <div className="row clearfix">
                                                        <div className="col-lg-6 col-md-6 col-sm-12 image-column">
                                                            <figure className="image-box"><img src="assets/images/resource/spain-custom.jpg" alt="" /></figure>
                                                        </div>
