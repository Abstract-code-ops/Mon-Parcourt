...
export default function Home() {
    ...
    return (
        <>
        <Layout headerStyle={1} footerStyle={1} breadcrumbTitle={t('breadcrumb.studentVisas')} bgImage="url(assets/images/background/visa-breadcrumb.jpg)">
                ...
                <li><Link href="visa-details-2">{t('breadcrumb.workingVisas')}</Link></li>
                <li><Link href="visa-details-3">{t('breadcrumb.residenceVisas')}</Link></li>
                <li><Link href="visa-details-4" className="current">{t('breadcrumb.studentVisas')}</Link></li>
                ...
                <h2>{t('pages.student.title')}</h2>
                <p>{t('pages.student.intro')}</p>
                            </div>
                            <figure className="image-box"><img src="assets/images/resource/visa-19.jpg" alt="" /></figure>
                            <div className="lower-text">
                <p>{t('pages.student.lower')}</p>
                            </div>
                        </div>
                        <div className="content-two mb_35">
                            ...
                            <div className="col-lg-6 col-md-6 col-sm-12 left-column">
                                <div className="left-content">
                                    <h3>{t('pages.student.leftTitle')}</h3>
                                    <p>{t('pages.student.leftP1')}</p>
                                    <p><Trans i18nKey="pages.student.leftP2" ns="visa" /></p>
                                </div>
                            </div>
                            <div className="col-lg-6 col-md-6 col-sm-12 right-column">
                                <div className="right-content">
                                    <h3>{t('pages.student.rightTitle')}</h3>
                                    <ul className="list-item clearfix">
                                        <li><Link href="javascript:void(0)" style={{"cursor": "default"}}>{t('pages.student.r1')}</Link></li>
                                        <li><Link href="javascript:void(0)" style={{"cursor": "default"}}>{t('pages.student.r2')}</Link></li>
                                        <li><Link href="javascript:void(0)" style={{"cursor": "default"}}>{t('pages.student.r3')}</Link></li>
                                    </ul>
                                </div>
                            </div>
                            </div>
